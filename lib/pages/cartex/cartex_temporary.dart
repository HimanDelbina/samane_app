...
class CartexTemporary extends StatefulWidget {
  const CartexTemporary({super.key});

  @override
  State<CartexTemporary> createState() => _CartexTemporaryState();
}

class _CartexTemporaryState extends State<CartexTemporary> {
  @override
  Widget build(BuildContext context) {
    double my_height = MediaQuery.of(context).size.height;
    double my_width = MediaQuery.of(context).size.width;
    context.read<GetCartexTemporary>().fetchData;
    return Consumer<GetCartexTemporary>(builder: (context, value, child) {
          ...
          : value.error
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return value.map[index].is_temporary == true
                        ? show_widget(
