...
class DriverRejectPage extends StatefulWidget {
  const DriverRejectPage({super.key});

  @override
  State<DriverRejectPage> createState() => _DriverRejectPageState();
}

class _DriverRejectPageState extends State<DriverRejectPage> {
  List user_data = [];
  @override
  Widget build(BuildContext context) {
    double my_height = MediaQuery.of(context).size.height;
    double my_width = MediaQuery.of(context).size.width;
    context.read<GetDirectionRejectDriver>().fetchData;
    return Consumer<GetDirectionRejectDriver>(
